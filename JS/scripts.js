jQuery(document).ready(function () {
    ...
    jQuery(".home").click(function () {
        jQuery(".s-about").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-service").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-home").animate({ left: '46%' }, 10).css({ 'width': '45.5%', "opacity": '1', 'transition': '.5s' });
        jQuery(".s-portfolio").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-testimonial").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-gallery").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
    });
    jQuery(".about").click(function () {
        jQuery(".s-about").animate({ left: '46%' }, 10).css({ 'width': '45.5%', "opacity": '1', 'transition': '.5s' });
        jQuery(".s-home").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-service").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-portfolio").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-gallery").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
        jQuery(".s-testimonial").animate({ right: '8%' }, 10).css({ 'width': '20%', "opacity": '0', 'transition': '.5s' });
